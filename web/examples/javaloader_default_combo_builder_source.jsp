...
<jsp:include page="inc/config.jsp" />
    ...
    loader.combine = true;
    //.comboBase="http://localhost:8084/YUIJavaLoader/combo?";
...
<body class="yui-skin-sam">
    <a href="http://github.com/levancho/YUIJavaLoader/blob/master/web/examples/javaloader_default_combo_builder_source.jsp"   target="_blank" > Source</a>
